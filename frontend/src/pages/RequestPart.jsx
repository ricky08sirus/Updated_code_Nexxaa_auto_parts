// RequestPart.jsx - Backend Integrated Version with Offer & Image
    ...
    return (
      <div className="product-details">
        <div className="product-error">
          ...
          <button onClick={() => navigate("/request-part")}>Go to Home</button>
        </div>
      </div>
    );
  }
    ...
    try {
      ...
      if (response.ok && data.success) {
        ...
        setTimeout(() => {
          setShowPopup(false);
          setTimeout(() => {
            navigate("/order-a-part/thank-you", {
              state: {
                year,
                manufacturerName,
                modelName,
        ...
        <div className="success-popup-overlay" onClick={handleClosePopup}>
          <div className="success-popup" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="success-popup-content">
              ...
              <p>
                Our team will review your request and contact you within 2-45 minutes
